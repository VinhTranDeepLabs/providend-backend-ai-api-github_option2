...
from routers import login, question_analysis, meeting, question_template, advisor, client, summarization, transcript, process, feedback
import uvicorn
...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:5173",
        "http://localhost:3000",
        "https://web-providend-ai-dev-qadujv.azurewebsites.net",
    ],
